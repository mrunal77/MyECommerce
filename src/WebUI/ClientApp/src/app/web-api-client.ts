...
export interface ITodoItemsClient {
    ...
    update(command: UpdateTodoItemCommand): Observable<FileResponse>;
    updateItemDetails(command: UpdateTodoItemDetailCommand): Observable<FileResponse>;
...
export interface ITodoListsClient {
    ...
    update(command: UpdateTodoListCommand): Observable<FileResponse>;
